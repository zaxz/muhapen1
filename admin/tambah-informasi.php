			...
			<div class="box-body">
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<!-- <div name="keterangan" id="keterangan"></div> -->
				...
				if (isset($_POST['submit'])) {
					...
					if (!in_array($formatfile, $allowedtype)) {
						...
						$simpan = mysqli_query($conn, "INSERT INTO informasi(id, judul, keterangan, gambar, created_at, updated_at, created_by) VALUES (
											null,
											'".$judul."',
											'" . $ket . "',
											'" . $rename . "',
